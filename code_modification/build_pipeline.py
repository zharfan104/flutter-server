...
class BuildPipelineService:
    ...
    async def execute_pipeline(self, user_request: str, context: Optional[Dict] = None) -> PipelineResult:
        ...
        try:
            ...
            modification_result = await self._execute_code_modification(user_request, context)
    ...
    async def _execute_code_modification(self, user_request: str, context: Optional[Dict] = None) -> ModificationResult:
        ...
        return await self.code_modifier.modify_code(modification_request)
